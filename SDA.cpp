...
SDA::SDA(int numStates, int numChars, int maxRespLen, int outputLen, int initState, bool verbose, int maxStates)
{
    ...
    create();
    if (verbose)
        cout << "SDA made with " << numStates << " states." << endl;
}
...
int SDA::addState()
{
    ...
    if (verbose)
    {
        cout << "Added state " << (numStates - 1) << ". Connected via state " << connect_state << ", char " << connect_char << endl;
    }
    return 0;
}
...
int SDA::deleteState()
{
    ...
    if (verbose)
    {
        cout << "Deleted state " << delete_state << ". New numStates: " << numStates << endl;
    }
    return 0;
}
